 ...
 * @param {String} config.comboBase The Combo service base path. Ex:  * @param {String} config.root The root path to prepend to module names for the combo service. Ex: `2.5.2/build/`
